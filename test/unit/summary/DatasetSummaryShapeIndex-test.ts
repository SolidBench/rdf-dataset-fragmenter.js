...
import { DatasetSummaryShapeIndex, IShapeEntry, IShapeIndexEntry, IUndescribedDataModel, ResourceFragmentation } from "../../../lib/summary/DatasetSummaryShapeIndex";
...
describe("DatasetSummaryShapeIndex", () => {
    ...
    describe("register", () => {
        ...
        it("should register a triple with a single fragmentation", () => {
            ...
            expect((<any>collector).contentHandled).toStrictEqual(expectedHandleContent);
        });
        ...
        it("should not register a triple with a subject not related to the dataset", () => {
            ...
            expect((<any>collector).contentHandled).toStrictEqual(new Map());
        });
