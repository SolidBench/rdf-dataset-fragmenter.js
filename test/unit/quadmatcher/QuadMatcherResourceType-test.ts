...
describe('QuadMatcherResourceType', () => {
  ...
  describe('with matchFullResource', () => {
    beforeEach(() => {
      matcher = new QuadMatcherResourceType('vocabulary/Person$', true);
    });
  ...
  describe('without matchFullResource', () => {
    beforeEach(() => {
      matcher = new QuadMatcherResourceType('vocabulary/Person$', false);
    });
    ...
    describe('matches', () => {
      ...
      it('should return true on applicable type quad but not the following triples of that resource', async() => {
        expect(matcher.matches(DF.quad(
          DF.namedNode('http://www.ldbc.eu/a.ttl'),
          DF.namedNode('ex:p0'),
          DF.namedNode('ex:o0'),
